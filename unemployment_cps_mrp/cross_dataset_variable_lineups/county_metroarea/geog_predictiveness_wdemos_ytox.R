...
setwd("~/unemployment/unemployment_cps_mrp/cross_dataset_variable_lineups/county_metroarea/")
...
jpeg("check_synthetic_occs_ytox.jpeg", width=30, height=23, units="in", res=300)
par(mfrow=c(7,10), mar=c(1,1,3,1), mgp=c(1,0.01,0), tck=0.005, lwd=0.5, pty="s", family="PT Sans")
